...
public class ObjectFactory {
    ...
    private final static QName _TotalizarValorEstoqueGeral_QNAME = new QName("http://servico.cba.ifmt/", "totalizarValorEstoqueGeral");
    private final static QName _TotalizarValorEstoqueGeralResponse_QNAME = new QName("http://servico.cba.ifmt/", "totalizarValorEstoqueGeralResponse");
    private final static QName _TotalizarValorEstoqueProduto_QNAME = new QName("http://servico.cba.ifmt/", "totalizarValorEstoqueProduto");
    private final static QName _TotalizarValorEstoqueProdutoResponse_QNAME = new QName("http://servico.cba.ifmt/", "totalizarValorEstoqueProdutoResponse");
    ...
    public JAXBElement<TotalizarValorEstoqueGeral> createTotalizarValorEstoqueGeral(TotalizarValorEstoqueGeral value) {
        return new JAXBElement<TotalizarValorEstoqueGeral>(_TotalizarValorEstoqueGeral_QNAME, TotalizarValorEstoqueGeral.class, null, value);
    }
    ...
    public JAXBElement<TotalizarValorEstoqueGeralResponse> createTotalizarValorEstoqueGeralResponse(TotalizarValorEstoqueGeralResponse value) {
        return new JAXBElement<TotalizarValorEstoqueGeralResponse>(_TotalizarValorEstoqueGeralResponse_QNAME, TotalizarValorEstoqueGeralResponse.class, null, value);
    }
    ...
    public JAXBElement<TotalizarValorEstoqueProduto> createTotalizarValorEstoqueProduto(TotalizarValorEstoqueProduto value) {
        return new JAXBElement<TotalizarValorEstoqueProduto>(_TotalizarValorEstoqueProduto_QNAME, TotalizarValorEstoqueProduto.class, null, value);
    }
    ...
    public JAXBElement<TotalizarValorEstoqueProdutoResponse> createTotalizarValorEstoqueProdutoResponse(TotalizarValorEstoqueProdutoResponse value) {
        return new JAXBElement<TotalizarValorEstoqueProdutoResponse>(_TotalizarValorEstoqueProdutoResponse_QNAME, TotalizarValorEstoqueProdutoResponse.class, null, value);
    }
